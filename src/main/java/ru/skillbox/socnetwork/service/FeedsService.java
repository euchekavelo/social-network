...
public class FeedsService {
  ...
  private Map<String, Object> getPost() { //TODO: получать список постов с репы
    ...
    person.setPhoto("/static/img/person.jpg");
    ...
    Map<String, Object> post = Map.ofEntries
      ...
      new AbstractMap.SimpleEntry<>("comments", list) //TODO: генерация коментов
      );
    return post;
  }

  public Map<String, Object> getFeeds(){ //TODO: Получение токена
